...
const Footer = () => {
  ...
  const companyName = 'SGTULook';
  const [showShareModal, setShowShareModal] = useState(false);

  const watsapp = 5491141461312
  const mensaje = 'Hola,%20me%20interesa%20consultar%20por%20un%20look'
  const EMAIL_SGTULOOK = 'hola.tulook@gmail.com';
  ...
  const shareWhatsApp = useCallback(() => {
    const text = encodeURIComponent('Te comparto esta inspo');
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
            ...
            <div className="lg:col-span-4">
              ...
              <p className="text-sm text-slate-400 leading-relaxed max-w-sm mb-6">
                Descubrí un estilo único con Sil Tu Look. Looks exclusivos y tendencias en peinados 
            ...
            <div className="lg:col-span-2">
              ...
              <ul className="space-y-3">
                {[
                  { label: 'Peinados', href: '/categoria/peinados' },
                  { label: 'Cortes', href: '/categoria/cortes' },
                ].map((item) => (
                  <li key={item.href}>
            ...
            <div className="lg:col-span-4">
              ...
              <div className="space-y-4 mb-6">
                ...
                >
                  ...
                  <span className="group-hover:text-white transition-colors">{EMAIL_SGTULOOK}</span>
                </a>
